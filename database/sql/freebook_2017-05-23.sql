...
# Database: freebook
# Generation Time: 2017-05-23 15:51:11 +0000
# ************************************************************
...
CREATE TABLE `books` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '书籍名称',
  `preview` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '封面图片',
  ...
  `enable` int(11) NOT NULL DEFAULT '1' COMMENT '是否开启,默认开启 1 => 开启 0 => 关闭',
...
CREATE TABLE `members` (
  ...
  `praise_count` int(11) NOT NULL DEFAULT '0' COMMENT '用户赞的数量',
  `is_confirmed` int(11) NOT NULL DEFAULT '0' COMMENT '用户是否激活账户 0 => 未激活 1 => 激活',
  `confirm_token` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '注册Token',
  `reset_token` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '找回密码Token',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
...
INSERT INTO `members` (`id`, `avatar`, `name`, `email`, `password`, `enable`, `praise_count`, `is_confirmed`, `confirm_token`, `reset_token`, `created_at`, `updated_at`)
VALUES
	(8,NULL,'Petard','scumpetard@gmail.com','$2y$10$cSU2FKRZ4PKupLsPV1fc6ulyVOrjFZGlzIepCb.qM6BbajsOpld3i',1,0,1,'Yztd0WQgWjuz9QbE',NULL,'2017-05-23 23:13:48','2017-05-23 23:19:57');
...
VALUES
	...
	('2017_05_22_214715_create_books_table',2),
	('2017_05_23_023405_create_members_table',3);
...
VALUES
	(1,'/uploads/admin-avatar/1495366482avatar.jpg','Petard','scumpetard@gmail.com','$2y$10$cG1hmXFaiddBIUoT1g56jeCZ0.P4S7BvSQJx1O93Xqd1NoQ6XmQAy',1,'4LvRgjbOAkCaHkIhw3euzAYMFvG1GyQhHMRd0bXsVadZHILCtjJ2PjRLeUod','2017-05-21 18:35:46','2017-05-22 21:07:06');
